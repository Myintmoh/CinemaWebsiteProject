    ...
    <div class="container">
		<div class="row">
		    ...
		    <?php 
                ...
                try {
                    include 'connectionpdo.php';
                    $sql="INSERT INTO movie_tbl(title, poster, release_date, description, cast, duration, trailer_link, status, seat_prize) VALUES(?,?,?,?,?,?,?,?,?)";
                    $sq= $db->prepare($sql);
                    $title= $_POST['title'];
                    ...
                    if($sq->execute(array($title, $photo, $date, $description, $cast, $duration, $link, $status, $seatprize))){   
                        echo "<script>
